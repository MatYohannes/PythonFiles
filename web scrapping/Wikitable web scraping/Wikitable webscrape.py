...
# Finding the world map
# world_image = soup.find_all('a', class_='image')
# # print(world_image)
#
# image_info = []
#
# for image in world_image:
...
#     real_name = ''.join(e for e in images[1] if e.isalnum())
#
#     file = open("C://image//bs//{}.jpg".format(real_name), 'wb')
#
